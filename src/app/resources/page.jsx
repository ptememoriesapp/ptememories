    ...
    types: [
      ...
      },
      {
        ...
        tips: [
          ...
          'Use discourse markers: "On the one hand...", "In contrast...", "Overall, the group..."',
          'Budget 60–70 seconds — shorter risks losing content marks, longer risks fluency marks.',
          'You don\'t need to state your own opinion — just summarize what was said.',
        ],
...
const SCORING_TABLE = [
  ...
  { type: 'Summarize Group Discussion',sp: true, wr: false, rd: false, li: true  },
